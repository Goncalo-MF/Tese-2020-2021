...
Q = [100 0 0 0; %Q maior aumenta performance mas aumenta custo também
    0 100 0 0;  %Q para cada variavel, x xdot, o odot
...
if(s==-1)
    y0 = [0; 0; 0;0];
    [t,y] = ode45(@(t,y)Copy_of_derivatives(t,y,m,M,L,g,d,K),tspan,y0);
